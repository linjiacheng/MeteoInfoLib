...
public class LonLatAxis extends Axis implements Cloneable {
     ...
     * @param isLon 
     */
    public LonLatAxis(String label, boolean isX, boolean isLon){
        super(label, isX);
    ...
    /**
     * Set if is longitude axis
     * @param value Boolean
     */
    public void setLonAxis(boolean value){
        this.lonAxis = value;
    }
