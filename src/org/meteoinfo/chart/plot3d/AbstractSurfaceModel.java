...
import org.meteoinfo.chart.plot3d.surface.ColorModelSet;
 ...
 * {@link SurfaceModel} interface. Writting is available throught setters for
 * any properties, and through a simple "Plotter" interface, to fill the curves.
 */
public class AbstractSurfaceModel implements SurfaceModel {
    ...
    class PlotterImpl implements Plotter {
         ...
         * position i.
         *
         * @param i index 0<=i<=calcDivisions. @author er
         * ic
         */
        public float getX(int i) {
            return xi + i * stepx;
         ...
         * position i.
         *
         * @param j index 0<=j<=calcDivisions. @author er
         * ic
         */
        public float getY(int j) {
            return yi + j * stepy;
        ...
        /**
         * Put an actual value at the (i,j) position for both first and second
         * curve
         *
         * @param i index 0<=i<=calcDivisions. @param j
         * index 0<=j<=calcDivisions. @param v
         * value at that point.
         * @see package.class
         * @author eric
         */
    ...
    protected int ycalcDivisions = INIT_CALC_DIV;
    ...
    @Override
    public int getYCalcDivisions() {
        return ycalcDivisions;
    }
    ...
    @Override
    public int getYDispDivisions() {
        if (dispDivisions > ycalcDivisions) {
            dispDivisions = ycalcDivisions;
        }
        while ((ycalcDivisions % dispDivisions) != 0) {
            dispDivisions++;
        }
        return dispDivisions;
    }
    ...
    /**
     * factory to get a plotter, i.e. the best way to append data to this
     * surface model
     *
     * @param calcDivisions
     * @return
