...
public abstract class AbstractSurfaceModel implements SurfaceModel {
    ...
    public void exportCSV(File file) throws IOException {
        ...
        ycalcDivisions = getYCalcDivisions();
        // func1calc = f1; func2calc = f2;

        stepx = (xx - xi) / calcDivisions;
        stepy = (yx - yi) / ycalcDivisions;
    ...
    public void setYCalcDivisions(int ycalcDivisions) {
        getPropertyChangeSupport().firePropertyChange("ycalcDivisions", this.ycalcDivisions, this.ycalcDivisions = ycalcDivisions);
    }
