...
public class ColorModelSet implements SurfaceColor
{
	...
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getBackgroundColor()
	 */
	public Color getBackgroundColor(){return lightColor;}
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getLineBoxColor()
	 */
	public Color getLineBoxColor() {return lineboxColor;}
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getBoxColor()
	 */
	public Color getBoxColor() {return boxColor;}
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getLineColor()
	 */
	public Color getLineColor(){return lineColor;}
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getTextColor()
	 */
	public Color getTextColor() {return lineColor;}
	
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getLineColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getPolygonColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getFirstPolygonColor(float)
	 */
	...
	/* (non-Javadoc)
	 * @see org.meteoinfo.chart.plot3d.SurfaceColor#getSecondPolygonColor(float)
	 */
