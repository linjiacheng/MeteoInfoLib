 ...
 * @author Yaqiang Wang
 */
public class Plot3D_bak extends Plot {
    ...
    SurfaceColor colors;
    private Plot3D_bak.JSurfaceChangesListener surfaceChangesListener;
     ...
     */
    public Plot3D_bak(JPanel panel){
     ...
     */
    public Plot3D_bak(JPanel panel, SurfaceModel model){
        this.panel = panel;
        this.legends = new ArrayList<>();
        //surfaceChangesListener = new JSurfaceChangesListener();
        //Plot3D_bak.JSurfaceMouseListener my = new Plot3D.JSurfaceMouseListener();
//        if (this.panel != null){
...
//                    lastFocused = Plot3D_bak.this.panel;
//                }
//            });
//        }
        setModel(model);
