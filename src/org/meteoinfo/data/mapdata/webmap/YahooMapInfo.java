...
//        super("YahooMap", 1, 17, 19,
//                256, true, true, // tile size is 256 and x/y orientation is normal
//                "https://%1$d.base.maps.api.here.com/maptile/%2$s/maptile/ef83a04284/normal.day/%3$d/%4$d/%5$d/256/png8?lg=ENG&token=TrLJuXVK62IQk0vuXFzaig%3D%3D&requestid=yahoo.prod&app_id=eAdkWGYRoc4RfxVo0Z4B",
//                "x", "y", "z");
    }
//    // </editor-fold>
...
//    // <editor-fold desc="Methods">
    ...
    public String getTileUrl(int x, int y, int zoom, String language) {
        ...
        //String url = String.format(this.baseURL, serverNum, version, zoom, x, y);
        return url;
    }
